...
ALLOWED_HOSTS = [os.environ.get('HOSTNAME','plyn85-blog-app.herokuapp.com')]
...
# Media root is a path to a directory where we like django to store uploaded files
# this is saying that the media root will be in our base directory an will have a dir in there called media
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
# this is how we access profile image in the browser
MEDIA_URL = '/media/'
CRISPY_TEMPLATE_PACK = 'bootstrap4'
# overriding default url path after a user logs In
